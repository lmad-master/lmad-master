...
**Frontend & UI:**
`Vue.js` `React` `Next.js` `TypeScript` `JavaScript` `Tailwind CSS` `Inertia.js`
...
*   Simuladores en Realidad Virtual y hardware personalizado como dispositivos _companion_ de escritorio para mi equipo.

<div align="center">
  <i>Expandiendo la realidad. ✨</i>
</div>
